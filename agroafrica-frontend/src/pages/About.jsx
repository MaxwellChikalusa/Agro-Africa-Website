...
export default function About() {
  return (
    <div style={page}>
      {/* Hero image */}
      <img src="/about.jpg" style={heroStyle} alt="About Agro Africa Trading" />
      ...
      <div style={cardsContainer}>
        <FarmCard
          ...
          description="Master's degree in Business Administration (MBA), BSc in Accounting -Provides strategic leadership, financial oversight, and overall business direction for Agro Africa Trading."
        ...
        <FarmCard
          ...
          description="BSc in Accounting. Malawi College Of Accountacy, Oversees financial planning, budgeting, and financial reporting of the company."
        ...
        />
        <FarmCard
          title="Tractor Operators"
          img="/gift.jpg"
          label="MR. GIFT LUSBAD"
          description="We have 5 Licensed professional drivers responsible for operating tractors and farm machinery."
